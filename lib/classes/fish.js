  ...
  checkForFish(client, message, permissionsBitfield) {
    ...
    axios({
      ...
      validateStatus: function (status) {
        // Accept both 200 (match found) and 404 (no match) as valid responses
      ...
      .catch((e) => {
        // Only log actual errors (network failures, timeouts, etc.)
        // 404 responses are now handled in .then() above
        console.log("[Anti-Phishing API] Check completed");
      });
  }
}
